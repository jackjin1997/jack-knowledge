...
def hunt():
    ...
    # 1. Find trending repos (simplified: search for stars > 1000 created/updated recently)
    ...
    for repo in repos:
        ...
        issues_json = run_gh_command(['issue', 'list', '--repo', name, '--label', 'help wanted', '--json', 'number,title,url,labels', '--limit', '3'])
